...
The latest version of JDK is currently 26 while the latest version of JRE is currently 8. We've noticed that instructions sometimes mention the JDK version when talking about JRE. We probably downloaded from here: https://www.java.com/en/download/ 
